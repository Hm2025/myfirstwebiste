...
@page { margin: 0; }
	...
	?>
		<header>
			...
			<address >
				<p>M.I.H FAM HOTEL,</p>
				<p>Along Airport Road,<br>New Benin,<br>Edo State.</p>
				<p>(+234) 813.7933.79</p>
			</address>
			<span><img alt="" src="assets/img/M.I.H FAM"></span>
		</header>
		<article>
			<h1>Recipient</h1>
			<address >
			...
			<table class="inventory">
				...
				<tbody>
					<tr>
						...
						<td><span data-prefix>NGN</span><span ><?php  echo $type_of_room;?></span></td>
						<td><span ><?php echo $nroom;?> </span></td>
						<td><span data-prefix>NGN</span><span><?php echo $ttot; ?></span></td>
					</tr>
					<tr>
						...
						<td><span ><?php echo $nroom;?> </span></td>
						<td><span data-prefix>NGN</span><span><?php echo $btot; ?></span></td>
					</tr>
					<tr>
						<td><span ><?php echo $meal; ?>  </span></td>
						<td><span ><?php echo $days; ?></span></td>
						<td><span data-prefix>NGN</span><span ><?php  echo $type_of_meal?></span></td>
						<td><span ><?php echo $nroom;?> </span></td>
						<td><span data-prefix>NGN</span><span><?php echo $mepr; ?></span></td>
					</tr>
				</tbody>
			</table>
		...
		<aside>
			...
			<div >
				<p align="center">Email :- info@mihfam.com || Web :- www.mihfam.com || Phone :- +234 37 3379 37 </p>
			</div>
		</aside>
	</body>
</html>
